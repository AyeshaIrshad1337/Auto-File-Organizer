...
zip_extensions = [".zip", ".rar", ".tar", ".gz", ".bz2", ".7z", ".xz", ".iso"]
python_extensions = [".py", ".pyc", ".pyo", ".pyw", ".pyz", ".pyzw", ".ipynb"]
...
class MoverHandler(FileSystemEventHandler):
    ...
    def check_python_files(self, entry, name):
        for python_extension in python_extensions:
            if name.endswith(python_extension) or name.endswith(python_extension.upper()):
